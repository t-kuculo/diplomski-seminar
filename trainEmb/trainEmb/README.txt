...
the global-context-aware neural language model 
...
- 
To train word embeddings on your own corpus, you need to provide 3 files, 
...
You need to replace <N> with the actual iteration number you want to load. 
We is the matrix
